<?php
        ...
        require 'dbconfig.php';
				...
				if(isset($_POST['submit']))
				{
						...
						$sql = "INSERT INTO contact (name,email,subject,msg) VALUES ('$name','$email','$sub','$message');";
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
							...
							<p>India</p>
							<p>Mobile: +91 9898989898 </p>
							<p>Email: info@e-CART.com</p>
	    				</address>
