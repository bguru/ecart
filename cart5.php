        ...
        require 'dbconfig.php';
		...
		
			{
				...
				if(is_array($row))
				{
					...
					header("location:checkout5.html");
					exit();					
				}
				else
				{
				...
				<table class="table table-condensed">
					...
					<tbody>
						<tr>
							...
							<td class="cart_total">
								<p class="cart_total_price">Rs.4500</p>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="row">
					...
					<div class="col-sm-4">
						<div class="total_area">
							<ul>
								<li>Cart Sub Total <span>Rs.4500</span></li>
								<li>Eco Tax <span>Rs.100</span></li>
								<li>Shipping Cost <span>Free</span></li>
								<li>Total <span>Rs.4600</span></li>
							</ul>
						</div>
					</div>
			</div>
